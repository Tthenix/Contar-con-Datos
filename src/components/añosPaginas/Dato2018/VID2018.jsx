...
const VID2018 = () => {
  useEffect(() => {
    const divElement = document.getElementById('viz1692113485245');
  ...
  return (
    <div className='tableauPlaceholder' id='viz1692113485245' style={{ position: 'relative' }}>
      <noscript>
        <a href='#'>
          <img
            alt='VID'
      ...
      <object
        ...
        data-site_root=''
        data-name='VID2018/VID1'
        data-tabs='no'
        data-toolbar='yes'
        data-static_image='https://public.tableau.com/static/images/VI/VID2018/VID1/1.png'
