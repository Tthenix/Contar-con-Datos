...
const Hortalizas2018 = () => {
  useEffect(() => {
    const divElement = document.getElementById('viz1692113369740');
  ...
  return (
    <div className='tableauPlaceholder' id='viz1692113369740' style={{ position: 'relative' }}>
      <noscript>
        <a href='#'>
          <img
            alt='Hortalizas'
      ...
      <object
        ...
        data-site_root=''
        data-name='Hortalizas2018/Hortalizas1'
        data-tabs='no'
        data-toolbar='yes'
        data-static_image='https://public.tableau.com/static/images/Ho/Hortalizas2018/Hortalizas1/1.png'
