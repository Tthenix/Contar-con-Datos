...
const Frutales2017 = () => {
  useEffect(() => {
    const divElement = document.getElementById('viz1692112693244');
  ...
  return (
    <div className='tableauPlaceholder' id='viz1692112693244' style={{ position: 'relative' }}>
      <noscript>
        <a href='#'>
          <img
            alt='Frutales'
      ...
      <object
        ...
        data-site_root=''
        data-name='Frutales2017/Frutales'
        data-tabs='no'
        data-toolbar='yes'
        data-static_image='https://public.tableau.com/static/images/Fr/Frutales2017/Frutales/1.png'
