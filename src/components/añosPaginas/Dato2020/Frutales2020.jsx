...
const Frutales2020 = () => {
  useEffect(() => {
    const divElement = document.getElementById('viz1692114014177');
  ...
  return (
    <div className='tableauPlaceholder' id='viz1692114014177' style={{ position: 'relative' }}>
      <noscript>
        <a href='#'>
          <img
            alt='Frutales'
      ...
      <object
        ...
        data-site_root=''
        data-name='Frutales2020/Frutales3'
        data-tabs='no'
        data-toolbar='yes'
        data-static_image='https://public.tableau.com/static/images/Fr/Frutales2020/Frutales3/1.png'
