...
const Frutales2020 = () => {
  useEffect(() => {
    const divElement = document.getElementById('viz1692128393013');
  ...
  return (
    <div className='tableauPlaceholder' id='viz1692128393013' style={{ position: 'relative' }}>
      ...
      >
        ...
        <param name='name' value='Frutales2020/Frutales3' />
        <param name='tabs' value='no' />
        <param name='toolbar' value='yes' />
        <param
          name='static_image'
          value='https://public.tableau.com/static/images/Fr/Frutales2020/Frutales3/1.png'
        />
