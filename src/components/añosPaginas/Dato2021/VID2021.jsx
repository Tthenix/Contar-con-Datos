...
const VID2021 = () => {
  useEffect(() => {
    const divElement = document.getElementById('viz1692115121278');
  ...
  return (
    <div className='tableauPlaceholder' id='viz1692115121278' style={{ position: 'relative' }}>
      <noscript>
        <a href='#'>
          <img
            alt='VID'
      ...
      <object
        ...
        data-site_root=''
        data-name='VID2021/VID4'
        data-tabs='no'
        data-toolbar='yes'
        data-static_image='https://public.tableau.com/static/images/VI/VID2021/VID4/1.png'
