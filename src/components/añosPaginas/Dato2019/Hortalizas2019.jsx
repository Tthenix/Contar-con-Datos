...
const Hortalizas2019 = () => {
  useEffect(() => {
    const divElement = document.getElementById('viz1692113811805');
  ...
  return (
    <div className='tableauPlaceholder' id='viz1692113811805' style={{ position: 'relative' }}>
      <noscript>
        <a href='#'>
          <img
            alt='Hortalizas'
      ...
      <object
        ...
        data-site_root=''
        data-name='Hortalizas2019/Hortalizas2'
        data-tabs='no'
        data-toolbar='yes'
        data-static_image='https://public.tableau.com/static/images/Ho/Hortalizas2019/Hortalizas2/1.png'
