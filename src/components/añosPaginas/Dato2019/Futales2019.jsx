...
const Frutales2019 = () => {
  useEffect(() => {
    const divElement = document.getElementById('viz1692113735097');
  ...
  return (
    <div className='tableauPlaceholder' id='viz1692113735097' style={{ position: 'relative' }}>
      <noscript>
        <a href='#'>
          <img
            alt='Frutales'
      ...
      <object
        ...
        data-site_root=''
        data-name='Frutales2019/Frutales2'
        data-tabs='no'
        data-toolbar='yes'
        data-static_image='https://public.tableau.com/static/images/Fr/Frutales2019/Frutales2/1.png'
